...
const playTurn = () => {
    ...
    let roll = rollDice();
    let resultMessage = `Turn ${turn}: Player ${currentPlayer} rolls ${roll}\n`;
    ...
    message += resultMessage; // Append the result to the message
    updateUI();
};
...
const updateUI = () => {
    ...
    document.getElementById('current-player').textContent = gameOver ? '' : `Player ${currentPlayer}'s Turn`;
